    ...
    <section className="bg-primary-100 text-white px-4 sm:px-6 md:px-10 py-6 sm:py-8 text-center min-h-[40vh] sm:min-h-[50vh] flex flex-col justify-center">
      ...
      <div className="mt-6 sm:mt-8"> {/* Increased margin-top here */}
        <a
          ...
          target="_blank"
          className="inline-block bg-white hover:bg-gray-100 text-primary-100 font-bold py-2 px-4 sm:px-6 text-sm sm:text-base rounded-lg shadow-lg transition-colors duration-300 cursor-pointer"
        >
          Hire Talents
        </a>
        {/* <Link
          to="/projects"
          className="ml-4 bg-white hover:bg-gray-100 text-primary-100 font-bold py-2 px-6 rounded-lg shadow-lg transition-colors duration-300 cursor-pointer"
        >
          View Projects
        </Link> */}
      </div>
