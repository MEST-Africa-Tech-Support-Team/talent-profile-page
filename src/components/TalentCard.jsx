  ...
  return (
    <div className="bg-white shadow-md rounded-2xl p-3 sm:p-4 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
      ...
      <button
        ...
        className="mt-auto w-full sm:w-auto px-8 sm:px-12 py-2 text-xs sm:text-sm bg-[#28BBBB] text-white rounded-xl hover:bg-[#239999] transition-colors font-medium cursor-pointer" 
      >
        View Profile
      </button>
    </div>
